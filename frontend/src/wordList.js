export const wordList = {
    ru: {
        ...
        productList: {
            ...
            productType: 'Тип',
            price: 'Цена',
            isRefrigeratorRequired: 'Холодильник',
            ...
            downloadAppBtn: 'Скачать приложение для отслеживания геолокации'
        },
        loginBtn: 'Вход',
        authUserToolBar: {
        ...
        downloadApp : {
            title: 'Выберите платформу, на которую хотите скачать приложение',
            description: 'Это приложение нужно для того, чтобы вы могли отправлять свои геоданные клиентам, отслеживать своё местоположение, отслеживать путь до магазина и выбирать выполняемую заявку. Для запуска приложения выберите вашу платформу, скачайте и предоставьте все нужные разрешения'
        },
        pageNotFound: {
            title: '404 страница',
            title2: 'не найдена',
    ...
    kg: {
        ...
        productList: {
            ...
            productType: 'Түрү',
            price: 'Баа',
            isRefrigeratorRequired: 'Муздаткыч',
            ...
            mainPageTitle: 'Башкы бет',
            downloadAppBtn: 'Геолокацияны көзөмөлдөө колдонмосун тиркемени алыңыз'
        },
        loginBtn: 'Кирүү',
        authUserToolBar: {
        ...
        downloadApp : {
            title: 'Тиркемени алып үчүн келген платформаны тандаңыз',
            description: 'Бул колдонмо геодатаңызды кардарларга жөнөтүп, жайгашкан жериңизди байкап, дүкөнгө барчу жолду көзөмөлдөп жана аткарылып жаткан тиркемени тандай алышыңыз үчүн керек. Колдонмону иштетүү үчүн, платформаңызды тандап, алып, бардык уруксаттарды бериңиз'
        },
        pageNotFound: {
            title: '404 бул бет',
            title2: 'табылган жок',
